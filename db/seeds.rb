...
user2 = User.create!(alias: "MissHarpreetKaur", email:"harpreet@kaur.com", password:"password", password_confirmation:"password", city:"Brimingham", sector:"Consulting")
...
user3 = User.create!(alias: "Test User 1", email:"test1@test1.com", password:"password", password_confirmation:"password", city:"London", sector:"Advertising")
